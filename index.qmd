...
4. Brief discussion on pre-service teachers' understanding of sustainability as an implication of SDG 4.7.
...
- Data is collected from a public university in Ankara, capital city of Türkiye.
...
In data analysis, we intended to emerge profiles of pre-service teachers that reflect their understandings on sustainability.
...
::: fragment
::: nonincremental
After profiles were emerged, profiles were compared by their department and two researchers were coded the interviews.
:::
:::
:::
...
- Data was collected from pre-service teachers who enrolled a general elective course on sustainability.
...
##
### Implications of These Findings on SDG 4.7 Perspectives - I
...
- To examine the role of embedding sustainability concepts into teacher education programme, we conducted two complementary studies exploring pre-service teachers'
...
##
### Implications of These Findings on SDG 4.7 Perspectives - II
::: columns
::: {.column width="70%"}
::: nonincremental
::: {style="font-size: 20px"}
...
- In the second study, we assessed self-efficacy beliefs of pre-service teachers who enrolled a general elective course on sustainability
  - We identified that even though the pre-service teachers feels relatively confident that they are able to embrace a sustainability lifestyles, nearly 40% of them remained undecided on how to integrate sustainability into their teaching.
- Overall, the results of these studies implied that ESD embedded teacher education programme (e.g., discipline specific courses & embedding sustainability concepts into other modules/lectures) have a potential to promote pre-service teachers' level of knowledge as well as self-efficacy beliefs which are two of the important constructs influence teaching which, in turn, achieving SDG 4.7.
  - Some available studies (e.g.,Cockerell, 2020; Ferguson & Roofe, 2020) argued in a similar vein that more explicit and coordinated efforts are needed to achieve SDG 4.
...
#### Acknowledgement
::: {style="font-size: 24px"}
The studies presented in this talk was collaborated with my awesome colleagues Drs Şen, Kaplan Can, Cengizoğlu (left), and my PhD co-advisor, Prof Teksöz (right).
:::
::: {.columns}
:::: {.column width="50%"}
![](img/ef-102.jpg)
